...
export const literalTranslations: Record<Language, Record<string, string>> = {
  ...
  lt: {
    ...
    "Strava detail backfill: import all-time history": "Išsamus Strava užpildymas: importuoti visą istoriją",
    "Runs in background in small batches with request limits.": "Veikia fone mažomis porcijomis su užklausų ribojimu.",
    "Connect Strava to configure detail backfill scope.": "Prijunkite Strava, kad sukonfigūruotumėte išsamaus importo apimtį.",
