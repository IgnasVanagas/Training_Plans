...
export const literalTranslations: Record<Language, Record<string, string>> = {
  ...
  lt: {
    ...
    ,"Clans": "Klanai"
    ,"Create Clan": "Sukurti klaną"
    ,"No Clan Yet": "Dar neturite klano"
    ,"Create your own clan or search for an existing one to join. Clans let you chat with coaches and teammates.": "Sukurkite savo klaną arba ieškokite esamo, prie kurio prisijungti. Klanai leidžia bendrauti su treneriais ir komandos draugais."
    ,"Find a Clan": "Rasti klaną"
    ,"Find Clans": "Rasti klanus"
    ,"Search clans by name...": "Ieškoti klanų pagal pavadinimą..."
    ,"Start typing to find clans.": "Pradėkite rašyti, kad rastumėte klanus."
    ,"No clans found.": "Klanų nerasta."
    ,"Clan Name": "Klano pavadinimas"
    ,"Enter clan name...": "Įveskite klano pavadinimą..."
    ,"Description (optional)": "Aprašymas (neprivaloma)"
    ,"What is your clan about?": "Koks jūsų klano tikslas?"
    ,"Clan created": "Klanas sukurtas"
    ,"Your clan has been created!": "Jūsų klanas sukurtas!"
    ,"Could not create clan": "Nepavyko sukurti klano"
    ,"Join Clan": "Prisijungti prie klano"
    ,"members": "nariai"
