...
import DashboardCoachHome from "./DashboardCoachHome";
import DashboardSettingsTab from "./DashboardSettingsTab";
import DashboardRacesRecordsTab from "./DashboardRacesRecordsTab";
import DashboardCoachAthletesPage from "./DashboardCoachAthletesPage";
import DashboardAthleteProfileTab from "./DashboardAthleteProfileTab";
import DashboardTrainingZonesTab from "./DashboardTrainingZonesTab";
