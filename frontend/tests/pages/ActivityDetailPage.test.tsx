...
vi.mock("../../src/utils/localSnapshot", () => ({
...
vi.mock("../../src/components/activityDetail/mapHelpers", () => ({
  MapFitBounds: () => null,
  MapPanTo: () => null,
...
vi.mock("../../src/components/ShareToChatModal", () => ({
  default: () => <div data-testid="share-to-chat-modal">Share modal</div>,
}));

vi.mock("../../src/components/common/SkeletonScreens", () => ({
...
vi.mock("../../src/components/activityDetail/CommentsPanel", () => ({
  CommentsPanel: () => <div data-testid="comments-panel">Comments Panel</div>,
}));

vi.mock("../../src/components/activityDetail/SessionFeedbackPanel", () => ({
  SessionFeedbackPanel: () => <div data-testid="session-feedback-panel">Session Feedback</div>,
}));

vi.mock("../../src/components/activityDetail/ComparisonPanel", () => ({
...
vi.mock("../../src/components/activityDetail/BestEffortsPanel", () => ({
...
vi.mock("../../src/components/activityDetail/FullscreenMapModal", () => ({
  FullscreenMapModal: () => <div data-testid="fullscreen-map-modal">Fullscreen Map</div>,
}));

vi.mock("../../src/components/activityDetail/SelectedSegmentSummary", () => ({
